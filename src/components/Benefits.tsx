  ...
  const benefits = [
    {
      ...
      description:
        "Eliminate manual market monitoring and trade execution. The AI bot works 24/7 so you don't have to.",
      delay: "0",
    },
    {
      ...
      description:
        "AI-driven analysis identifies more profitable opportunities than humanly possible, enhancing your returns.",
      delay: "100",
    },
    {
      ...
      description:
        "Remove human emotions from trading decisions, avoiding common pitfalls that lead to losses.",
      delay: "200",
    },
    {
      ...
      description:
        "Benefit from cutting-edge AI and machine learning algorithms typically only available to institutional traders.",
      delay: "300",
    },
    {
      ...
      description:
        "Gain valuable market insights from the AI's analysis that can improve your overall trading knowledge.",
      delay: "400",
    },
    {
      ...
      description:
        "The self-learning AI continuously improves its strategies based on market performance and results.",
      delay: "500",
    },
  ];
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-trading-gray-medium">
            Experience the numerous advantages of automated AI trading that can
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-trading-gray-medium mb-6">
                Our AI trading bot represents the cutting edge of financial
                technology, bringing institutional-grade algorithms to
                individual traders.
              </p>
